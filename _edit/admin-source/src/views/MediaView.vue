        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="item in mediaItems" :key="item.id" class="hover">
              ...
              <td class="text-right">
                <div class="join">
                  <button @click="copyUrl(item.url)" class="btn btn-ghost btn-sm join-item tooltip tooltip-left" data-tip="Copy URL">
                    <IconCopy />
                  </button>
                  <a :href="item.url" download :download="item.filename" class="btn btn-ghost btn-sm join-item tooltip tooltip-left" data-tip="Download">
                    <IconDownload />
                  </a>
                  <button @click="deleteMedia(item.id)" class="btn btn-ghost btn-error btn-sm join-item tooltip tooltip-left" data-tip="Delete">
                    <IconTrash />
                  </button>
                </div>
              </td>
