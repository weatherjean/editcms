    ...
    <div v-for="(item, index) in items" :key="index" class="card bg-base-200 border">
      <div class="card-body p-4">
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="join">
            <button v-if="index > 0" type="button" @click="moveItem(index, -1)" class="btn btn-ghost join-item" title="Move up">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clip-rule="evenodd" />
              </svg>
            </button>
            <button v-if="index < items.length - 1" type="button" @click="moveItem(index, 1)" class="btn btn-ghost join-item" title="Move down">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
              </svg>
            </button>
            <button type="button" @click="removeItem(index)" class="btn btn-error join-item" title="Delete">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 20 20" fill="currentColor">
