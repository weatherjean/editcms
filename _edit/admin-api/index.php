...
if (handleAuthRoutes($method, $path, $auth, $db)) {
    exit;
}
...
if (handleUserRoutes($method, $path, $db, $auth, $userId)) {
    exit;
}

if (handleEmailAdminRoutes($method, $path, $db)) {
    exit;
}

require_once __DIR__ . '/routes/config.php';
if (handleConfigRoutes($method, $path, $registry, $blocks)) {
    exit;
}

require_once __DIR__ . '/routes/media.php';
if (handleMediaRoutes($method, $path, $db, $userId)) {
    exit;
}

require_once __DIR__ . '/routes/content.php';
if (handleContentRoutes($method, $path, $db, $registry, $blocks, $userId)) {
    exit;
}
